define(['vue', 'jquery', 'area', 'filter-list', './content-list'], function (Vue, $, area, filterList, contentList) {
        ...
        var list = [
          {
            ...
            tabContent: {
              ...
              state : 0,
              items: [
                { name: '发布中职位', active: false, ajax: { key: ajaxKeys.status, value: 1  }, iconClassName: '' },
                { name: '已关闭职位', active: false, ajax: { key: ajaxKeys.status, value: 2  }, iconClassName: '' },
                { name: '已暂缓职位', active: false, ajax: { key: ajaxKeys.status, value: 3  }, iconClassName: '' },
                { name: '已成功职位', active: false, ajax: { key: ajaxKeys.status, value: 4  }, iconClassName: '' }
              ]
            }
          },
          {
