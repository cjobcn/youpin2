;(function(global, factory) {if (typeof module !== "undefined" && module.exports !== void 0) {var jade = require("jade-runtime");module.exports = factory(jade);}else if (typeof define === "function" && define.amd) {define("yp-template", ["jade"], factory);}else if (global.window === global) {global.ypTemplate = factory(global.jade);}})(this, function(jade) {var __exports = {};
